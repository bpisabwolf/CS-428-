...
public class HumidScriptAPI : MonoBehaviour
{
    string finalWeather;
    string rawWeather;
   ...
   string GetWeatherFromData(string raw){
     int findLength = "\"humidity\":".Length;
     int indEnd = raw.IndexOf("\"humidity\":") + findLength;
     int after = raw.IndexOf("},\"visibility\":");
      ...
      Debug.Log("Raw uri: " + uri);
        using (UnityWebRequest webRequest = UnityWebRequest.Get(uri))
        {
            ...
            else
            {
                ...
                weatherTextObject.GetComponent<TextMeshPro>().text = finalWeather + "%";
            }
        }
    }
}
